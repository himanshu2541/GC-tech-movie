      ...
      <div className="w-full h-full">
        ...
        <div className="absolute w-1/2 top-[12%] p-6 md:p-10">
          ...
          <div className="my-4 text-lg">
            <Link to ="/movies/573a13d7f29313caabda1952"><button className="flex items-center gap-2 bg-white text-black py-2 pl-3 pr-4 font-semibold rounded-md hover:bg-primary-red hover:text-white duration-300">
              <IoPlay /> Play
            </button></Link>
          </div>
          <div>
